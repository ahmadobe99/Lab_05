            ...
            child: Container(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold,color: Color.fromARGB(255, 212, 200, 166)),
                ),
                Divider(
                  height: 30,
                ),
                Text(
                  ...
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold,color: Color.fromARGB(255, 170, 138, 51)),
                ),
                  Divider(
                  height: 30,
                ),
